...
public class MapActivity extends Activity implements LocationListener, LoaderCallbacks<DealersList> {
    ...
    public Loader<DealersList> onCreateLoader(int aId, Bundle aArgs) {
        Log.i(LOGTAG, "onCreateLoader  " + mMyLocationOverlay.getLastFix() + " ONE KILOMETER");
        return new DealersDownloadTask(getApplicationContext(), mMyLocationOverlay.getLastFix(), Radius.ONE_KILOMETER);
    }
